...
export const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await login({ userId, email: formData.email }, token)
      navigate('/dashboard')
    } catch (err) {
      ...
      <div className="flex flex-1 items-center justify-center px-8 py-8">
        <div className="w-full max-w-5xl flex items-center justify-between gap-16">
          ...
          <div className="flex-1 max-w-sm">
            <div className="inline-flex items-center gap-2 bg-white/60 rounded-full px-4 py-2 mb-6 text-sm text-gray-600">
              <span className="w-2 h-2 rounded-full bg-primary inline-block" />
              Daily Tracking
            </div>
            <h1 className="text-4xl font-black text-gray-900 leading-tight mb-4">
              One Step Solution<br />
              <span className="text-primary">for all your</span> needs.
            </h1>
          ...
          <div className="w-full max-w-sm">
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-card p-8">
              ...
              <p className="text-gray-400 text-sm mb-6">Your personal mental wellness assistant is ready.</p>
